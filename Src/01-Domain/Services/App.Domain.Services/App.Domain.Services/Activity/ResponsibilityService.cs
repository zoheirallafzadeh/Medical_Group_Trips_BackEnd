...
namespace App.Domain.Services.Activity
{
    ...
    {
        private readonly IResponsibilityCommandRepository _commandRepository;
        private readonly IResponsibilityQueryRepository _queryRepository;
        ...
        {
            return await _queryRepository.Get(ResponsibilityId, translateCode, cancellationToken);
        }
        ...
        {
            return _queryRepository.Get(translateCode , cancellationToken);
        }

        public Task<List<ResponsibilityDto>> Get(List<int> ResponsibilityIds, CancellationToken cancellationToken)
        {
            return _queryRepository.Get(ResponsibilityIds , cancellationToken);
        }
        ...
        {
            return _queryRepository.Get(translateCode , ResponsibilityIds , cancellationToken) ;
        }
        ...
        {
            await _commandRepository.Update(responsibilityWithTranslationDto , cancellationToken);
        }
    }
}
